  ...
  class Renderer
    ...
    private
      ...
      def build_non_customer_sheet(wb, drives_without_customers, row_builder, header_builder, styles)
        wb.add_worksheet(name: I18n.t("reports.drives.tab_title_without_customer"), :page_setup => { fit_to_width: 1, orientation: :landscape, paper_size: 9 }) do |sheet|
      ...
      def build_customer_sheet(wb, customer, drives, row_builder, header_builder, styles)
        ...
        wb.add_worksheet(name: ws_name, page_setup: { fit_to_width: 1, orientation: :landscape, paper_size: 9 }) do |sheet|
